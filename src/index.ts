...
class ChromeManifestGeneratorPlugin implements RspackPluginInstance {
  ...
  apply(compiler: Compiler): void {
    const meta: ReturnType<typeof Meta> = Meta(compiler)
      ...
      compilation.hooks.processAssets.tapPromise({
        ...
        await Promise
          ...
          .then(([autoPermissions, meta]) => {
            ...
            compilation.emitAsset(relativeOutputPath, new sources.RawSource(JSON.stringify(manifest, null, 2)))
          })
          .catch(e => {
            throw e
          })
